...
const adminStudent = () => {
  ...
  const submitUser = async (e) => {
    const response = await fetch('/api/register', {
      method: 'POST',
      body: JSON.stringify({ email, password, firstName, lastName, prefix, role, assist }),
      headers: {
        ...
        />
          ...
          <Box width='200px'>
            ...
            <FormLabel htmlFor='firstName'>ID</FormLabel>
              ...
              <FormLabel htmlFor='password'>Assistant?</FormLabel>
              <Select placeholder='Select option' onChange={(e) => setAssist(e.target.value)}>
