import {
  ...
  export default function addClsInst({sections,stuID}){
  
    const submitSec = async (e, sectID) =>{
      const response = await fetch('/api/admin/stuAddClass',{
        method: 'POST',
        body: JSON.stringify ({ stuID, sectID }),
        headers: {
